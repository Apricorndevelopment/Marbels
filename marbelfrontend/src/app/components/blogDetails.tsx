  ...
  export default function BlogDetails({ blog }: { blog: BlogType }) {
    return (
      <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-md my-8">
        <Image src={`${process.env.NEXT_PUBLIC_API_URL}/${blog.blog_image}`} alt={blog.blog_name} width={100} height={100} className="w-full h-[300px] object-cover rounded-md mb-6"/>
