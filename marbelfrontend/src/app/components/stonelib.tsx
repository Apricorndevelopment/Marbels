...
export function StoneLib() {
  ...
  return (
    <aside className="p-5 bg-white border shadow-lg">
      ...
      <div className="flex flex-wrap sm:ps-5 items-center justify-center sm:justify-start gap-7 sm:gap-10 mt-7">
        {marbels.map((marbel, index) => (
          <div
            key={index}
            className="flex items-center justify-center flex-col gap-6 hover:bg-yellow-100 transition-colors duration-200 px-4 py-6"
          >
